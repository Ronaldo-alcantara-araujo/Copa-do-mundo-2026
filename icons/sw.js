const CACHE='copa2026-auto-chaveamento-v3';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icons/logo-fifa26.jpg','./icons/icon-192.png','./icons/icon-384.png','./icons/icon-512.png'];
